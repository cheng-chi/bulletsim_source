...
//	MatrixXf colSum = pZgivenC.colwise().sum();
//	VectorXf weights(pZgivenC.cols());
//	for (int t=0; t<pZgivenC.cols(); t++) {weights(t) = 1/colSum(0,t);}
//	pZgivenC = pZgivenC * weights.asDiagonal();

	for (int t=0; t<pZgivenC.cols(); t++)
		pZgivenC.col(t) /= pZgivenC.col(t).sum();
