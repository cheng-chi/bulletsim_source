...
//#define OSGBCOLLISION_MAJOR_VERSION (@OSGBCOLLISION_MAJOR_VERSION@)
//#define OSGBCOLLISION_MINOR_VERSION (@OSGBCOLLISION_MINOR_VERSION@)
//#define OSGBCOLLISION_SUB_VERSION (@OSGBCOLLISION_SUB_VERSION@)
